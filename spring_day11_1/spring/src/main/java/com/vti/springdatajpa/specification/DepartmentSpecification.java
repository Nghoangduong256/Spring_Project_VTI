...
//
//    public static Specification<DepartmentEntity> buildSpec(DepartmentFilterDto filter) {
...
//                Join<DepartmentEntity, AccountEntity> accountJoin = root.join("accounts", JoinType.LEFT);
